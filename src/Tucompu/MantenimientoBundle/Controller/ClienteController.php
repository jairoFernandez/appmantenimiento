...
use Tucompu\MantenimientoBundle\Entity\Cliente;
use Tucompu\MantenimientoBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MantenimientoBundle:Cliente')->findAll();

        return $this->render('MantenimientoBundle:Cliente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MantenimientoBundle:Cliente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MantenimientoBundle:Cliente')->find($id);
        ...
        return $this->render('MantenimientoBundle:Cliente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MantenimientoBundle:Cliente:edit.html.twig', array(
            'entity'      => $entity,
